...
public class ClasseTeste {
	...
	public static void main(String[] args) {
		...
		Medico e = new Medico(1, "Dexter", 322123, "5566431", "67867",
				new Endereco("rua dos medicos", "Recife", "Macaxeira", "4432345", "28391871", ""), "4121241",
				"08790872", new Login("5566431", "555", 1));

		Consulta c1 = new Consulta(d, LocalDateTime.of(2016, 9, 30, 16, 30), "", e);
		Consulta c2 = new Consulta(c, LocalDateTime.now(), "", e);
		// System.out.println(a.toString() + b.toString() + c.toString() +
		// d.toString() + e.toString() + c1.toString() + c2.toString());
		...
		dataP.atualizarPaciente(dataP.pesquisarPeloNome("Braulios Minimus III"), "Rodrigo", "well", "this is boring",
				LocalDate.now(), "blah blah",
				new Endereco("End of the World", "Hell", "Asfodelos", "Hades", "101", "01"));
