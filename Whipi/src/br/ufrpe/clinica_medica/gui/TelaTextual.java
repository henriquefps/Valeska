...
public class TelaTextual {
	...
	//Marcar consultas - nessa opção o usuário(recepcionista) interage com o paciente e o médico.
			if(op == 1){
				...
				//colocar opção para checar se esse médico já tem algo marcado nesse horário
