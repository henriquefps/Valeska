	...
	public void criarDados() {
		...
		try {
			...
			a.cadastrarMedico("Pedr�o", "342", "1235465", "34657823", "993245862", 'M',
					new Endereco("Rua Salvador", "Olinda", "Beberibe", "PE", "52012312", "APT1201"),
					LocalDate.of(1978, 2, 20), 1337, 10, "123");
			...
			// consulta.cadastrarConsulta(a.pesquisarMedico("123"),
			// paciente.pesquisarPaciente("987"), LocalDateTime.of(2016, 10, 7,
			// 16, 00));
